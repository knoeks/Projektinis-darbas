...
const NavBar = () => {
  ...
  return (
    <div className="md:px-8 md:py-8  xl:pr-0 box-border fixed top-0 left-0 z-50 w-full bg-light xl:h-full xl:w-fit">
      <div className="nav-container w-full xl:w-fit">
        <Logo className="logo" />
